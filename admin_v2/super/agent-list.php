			...
			<section class="main-content">
				...
				<div class="main-content-wrapper">
					...
					<div class="content-wrapper-header">
						<h1 class="page-title" data-lan-eng="Agent List">에이전트 목록</h1>
					</div>
					...
					<div class="content-wrapper-body">
							...
							<div class="list-header">
								...
								<form class="search-form" action="" method="get">
									...
									<div class="search-field">
										<input type="text" class="search-input" placeholder="고객명 검색" data-lan-eng="Agent Name Search">
						...
						<div class="controller">
							...
							<button type="button" class="jw-button typeB" onclick="temp_link('agent-registration.html')"><img src="../image/buttonB.svg" alt="">Add New Agent</button>
						</div>
