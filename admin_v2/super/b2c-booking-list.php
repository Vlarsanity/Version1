			...
			<section class="main-content">
				...
				<div class="main-content-wrapper">
					...
					<div class="content-wrapper-header">
						<h1 class="page-title" data-lan-eng="B2C Reservation List">B2C 예약 목록</h1>
					</div>
					...
					<div class="content-wrapper-body">
						...
						<div class="card-panel jw-mgt32">
							...
							<table class="jw-tableA">
								...
								<tbody>
									<tr onclick="temp_link('b2c-booking-detail.html')">
										<td class="no is-center">10</td>
										<td class="is-center">서울 벚꽃 명소 집중 탐방 5박 6일 패키지 – 전일정 가이드 및 식사 포함</td>
										...
										<td class="is-center">
											<span class="badge badge-blue" data-lan-eng="Payment completed"> 입금 대기</span>
										</td>
									</tr>
									<tr onclick="temp_link('b2c-booking-detail.html')">
										...
										<td class="is-center">Hyunwoo Park</td>
										<td class="is-center">
											<span class="badge badge-orange" data-lan-eng="Payment cancellation"> 예약 확정</span>
										</td>
									</tr>
									<tr onclick="temp_link('b2c-booking-detail.html')">
										...
										<td class="is-center">Hyunwoo Park</td>
										<td class="is-center">
											<span class="badge badge-gray" data-lan-eng="Payment Suspension"> 여행 완료</span>
										</td>
									</tr>
									<tr onclick="temp_link('b2c-booking-detail.html')">
										...
										<td class="is-center">Hyunwoo Park</td>
										<td class="is-center">
											<span class="badge badge-red" data-lan-eng="Trip completed"> 예약 취소</span>
										</td>
									</tr>
									<tr onclick="temp_link('b2c-booking-detail.html')">
										...
										<td class="is-center">Hyunwoo Park</td>
										<td class="is-center">
											<span class="badge badge-purple" data-lan-eng="Refund completed"> 환불 완료</span>
										</td>
									</tr>
									<tr onclick="temp_link('b2c-booking-detail.html')">
