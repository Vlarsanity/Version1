			...
			<section class="main-content">
				...
				<div class="main-content-wrapper">
					...
					<div class="content-wrapper-header">
						<h1 class="page-title" data-lan-eng="B2C Customer List">B2C 고객 목록</h1>
					</div>
							...
							<table class="jw-tableA">
								...
								<thead>
									<tr>
										...
										<th class="is-center" data-lan-eng="Customer Name">고객명</th>
										<th class="is-center" data-lan-eng="Agent Name">소속 지점명</th>
										<th class="is-center" data-lan-eng="Email">이메일</th>
										<th class="is-center" data-lan-eng="Contacts">연락처</th>
										<th class="is-center" data-lan-eng="Registration date/time">등록일시</th>
									</tr>
								</thead>
								<tbody>
									<tr onclick="temp_link('b2b-customer-detail.html')">
										<td class="no is-center">10</td>
										<td class="is-center">Jose Ramirez</td>
										<td class="is-center">Bacolod City</td>
										<td class="is-center">ramirez@gmail.com</td>
										<td class="is-center">+63 917 123 4567</td>
										<td class="is-center">2025-06-20 12:12</td>
									</tr>
									<tr onclick="temp_link('b2b-customer-detail.html')">
